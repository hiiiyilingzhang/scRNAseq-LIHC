...
```{r}
CairoPNG(file="../output/9.celltrajectory/ITH-heatmap.png",width=800,height=800)
...
If I don't use `job` package, R would be shut down easily!
```{r}
job::job(kegg.info= { kegg <- gsva(expr, msigdbr_list, kcdf="Gaussian",method = "gsva", parallel.sz = 10)
})
```
